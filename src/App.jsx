...
const doseTimes = ['٦ صباحاً', '٩ صباحاً', '١٢ ظهراً', '٦ مساءً', '٩ مساءً', 'صباحاً ومساءً', 'صباحاً وظهراً ومساءً', 'عند النوم', 'عند الحاجة']
const usageMethods = ['حبة بعد الطعام مباشرة', 'نصف حبة بعد الطعام مباشرة', 'حبة قبل الطعام', 'حبة على الريق', 'حبة عند النوم', 'حبتان بعد الطعام مباشرة', 'تُمضغ', 'توضع تحت اللسان']
